...
with right_col:
    ...
    st.markdown(
        ...
        <div class="info-card">
            ...
            <ul>
                <li><b>Lojistik Regresyon:</b> Temel risk faktörlerinin doğrusal etkisini modelleyen olasılıksal sınıflandırıcı.</li>
                <li><b>Karar Ağaçları / Random Forest:</b> Doğrusal olmayan etkileşimleri ve karmaşık ilişkileri yakalayan ansamble modeller.</li>
                <li><b>XGBoost:</b> Gradyan artırmalı ağaç tabanlı güçlü bir öğrenici; özellikle sınıf dengesizliğine karşı dayanıklı.</li>
    ...
    st.markdown(
        ...
        <div class="info-card">
            ...
            <ul>
                ...
                <li><b>ROC-AUC:</b> ≈ 0.80 (sınıfları ayırt etme gücü)</li>
